...
exports.PostcardApi = void 0;
var path_1 = __importDefault(require("path"));
var form_data_1 = __importDefault(require("form-data"));
var _1 = require("./");
var PostcardApi = /** @class */ (function () {
    function PostcardApi(client, options) {
        this.client = client;
     ...
     */
    PostcardApi.prototype.get = function (id) {
        var _a, _b, _c;
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.fire('GET', path_1.default.join(this.baseRoute, 'postcards', id), { 'x-api-key': this.client.apiKeys.mail })];
                    case 1:
                        resp = _d.sent();
                        ...
                        return [2 /*return*/, { success: (resp && !((_c = resp.payload) === null || _c === void 0 ? void 0 : _c.error)), postcard: resp.payload }];
                }
            });
        });
    };
     ...
     */
    PostcardApi.prototype.list = function (limit, skip) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.fire('GET', path_1.default.join(this.baseRoute, 'postcards'), { 'x-api-key': this.client.apiKeys.mail }, { skip: skip || 0, limit: limit || 40 })];
                    case 1:
                        resp = _d.sent();
                        if (((_a = resp === null || resp === void 0 ? void 0 : resp.response) === null || _a === void 0 ? void 0 : _a.status) >= 400) {
                            return [2 /*return*/, {
                        ...
                        return [2 /*return*/, { success: (resp && !((_c = resp.payload) === null || _c === void 0 ? void 0 : _c.error)), postcards: resp.payload }];
                }
            });
        });
    };
     ...
     */
    PostcardApi.prototype.create = function (postcard, options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var body, form_1, _loop_1, _i, _d, _e, k, v, headers, resp;
                ...
                switch (_f.label) {
                    case 0:
                        ...
                        if (Buffer.isBuffer(postcard.pdf)) {
                                            ...
                                            if (typeof v === 'object') {
                                                Object.entries(v).forEach(function (_a) {
                                                    ...
                                                    if (sv || sv === false || sv === 0 || sv === '') {
                                                        form_1.append(k + "[" + sk + "]", sv);
                                                    }
                                                });
                                            }
                                            else {
                                                form_1.append(k, v.toString());
                                            }
                                            break;
                                        case 'pdf':
                                            form_1.append(k, postcard.pdf, 'upload-content.pdf');
                                            break;
                                        case 'sendDate':
                                            if (Object.prototype.toString.call(v) === '[object Date]') {
                                                form_1.append(k, v.toISOString());
                                            }
                                            else {
                                                form_1.append(k, v.toString());
                                            }
                            ...
                            for (_i = 0, _d = Object.entries(postcard); _i < _d.length; _i++) {
                        ...
                        return [4 /*yield*/, this.client.fire('POST', path_1.default.join(this.baseRoute, 'postcards'), headers, undefined, body)];
                    case 1:
                        resp = _f.sent();
                        if (((_a = resp === null || resp === void 0 ? void 0 : resp.response) === null || _a === void 0 ? void 0 : _a.status) >= 400) {
                            return [2 /*return*/, {
     ...
     */
    PostcardApi.prototype.progress = function (id) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.fire('POST', path_1.default.join(this.baseRoute, 'postcards', id, 'progressions'), { 'x-api-key': this.client.apiKeys.mail })];
                    case 1:
                        resp = _d.sent();
                        if (((_a = resp === null || resp === void 0 ? void 0 : resp.response) === null || _a === void 0 ? void 0 : _a.status) >= 400) {
                            return [2 /*return*/, {
     ...
     * the appropriate error.
     */
    PostcardApi.prototype.delete = function (id) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.client.fire('DELETE', path_1.default.join(this.baseRoute, 'postcards', id), { 'x-api-key': this.client.apiKeys.mail })];
                    case 1:
                        resp = _d.sent();
                        if (((_a = resp === null || resp === void 0 ? void 0 : resp.response) === null || _a === void 0 ? void 0 : _a.status) >= 400) {
                            return [2 /*return*/, {
...
exports.PostcardApi = PostcardApi;
